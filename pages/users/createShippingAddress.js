...
const createShippingAddress = () => {
    ...
    return (
        <div className='mt-10 p-4 lg:w-285 bg-white sm:max-lg:flex sm:max-lg:flex-col sm:max-lg:items-center'>
            <div className=' lg:border-b-1'><PageName name={"Create new shipping address"} /></div>
            ...
            <div className='mt-6 lg:mx-8 p-5 w-full max-w-2xl lg:w-96  shadow-myshadow flex flex-col justify-between rounded-md' >
                <span className='font-medium mb-4'>Address Type</span>
                <div>
                    ...
                    <button className='w-24 h-10 rounded-md mr-3 border-1 border-black text-slate-300 font-thin text-sm hover:bg-black hover:text-white focus:bg-black focus:text-white'>Other</button>

                </div>
            </div>

            <div className='mt-3 lg:mx-8 p-5 w-full max-w-2xl lg:w-96 flex flex-row justify-between' >
