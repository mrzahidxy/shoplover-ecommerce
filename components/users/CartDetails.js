    ...
    <div className='flex flex-row flex-wrap mt-6'>
      ...
      <div className='flex flex-col lg:ml-6 w-96 h-36 rounded-md border-1 border-[#DADADA] bg-[#F6F6F6]'>
        <div className='ml-5 my-2'>
          ...
          <h1 className='text-sm w-72 flex-wrap'>{Address.address}</h1>
          <h1 className='text-sm'>{Address.phone}</h1>
        </div>
      </div>
