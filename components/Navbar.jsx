...
const Navbar = () => {
    ...
    return (
        ...
        <div className="bg-[#1b1b1bf7] text-white h-11 hidden md:flex flex-row justify-center items-center">
            <div className="w-full xl:w-[1500px] py-2 px-4 xl:py-4 h-full flex flex-row justify-between text-white">
                ...
                {/* middle navbars */}
                <div className="flex flex-row items-between justify-between shrink-0">
                ...
                {/* right app sale */}
                <div className="flex flex-row justify-end shrink items-center text-sm">
                    Download the App & get 20% OFF
